...
namespace Yuki {
	...
	void Renderer2D::Init()
	{
		...
		Ref<IndexBuffer> squareIB = IndexBuffer::Create(sqaureIndices, 6);
	...
	void Renderer2D::DrawQuad(const glm::vec2& position, const glm::vec2& size, const Ref<Texture2D>& texture, float tilingFactor /*= 1.0f*/, const glm::vec4& tintColor = glm::vec4(1.0f) /*= glm::vec4(1.0f)*/)
	{
		DrawQuad({ position.x, position.y, 0.0f }, size, texture, tilingFactor, tintColor);
	}

	void Renderer2D::DrawQuad(const glm::vec3& position, const glm::vec2& size, const Ref<Texture2D>& texture, float tilingFactor /*= 1.0f*/, const glm::vec4& tintColor = glm::vec4(1.0f) /*= glm::vec4(1.0f)*/)
	{
		YUKI_PROFILE_FUNCTION();
