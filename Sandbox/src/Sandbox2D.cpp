...
void Sandbox2D::OnUpdate(Yuki::Timestep ts)
{
	...
	
	{
		...
		Yuki::Renderer2D::DrawRotatedQuad({ -1.0f, 0.0f }, { 0.6f, 0.6f }, glm::radians(30.0f), { 0.8f, 0.2f, 0.3f, 1.0f });
		Yuki::Renderer2D::DrawQuad({ 0.5f, -0.5f }, { 0.5f, 0.75f }, { 0.2f, 0.3f, 0.8f, 1.0f });
		Yuki::Renderer2D::DrawQuad({ 0.0f, 0.0f, -0.1f }, { 10.0f, 10.0f }, m_Texture, 10.0f);
